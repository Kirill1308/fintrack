...
INSERT INTO wallet (name, balance, currency)
VALUES ('John Wallet', 1000.00, 'USD'),
       ('Mike Wallet', 5000.00, 'USD'),
       ('Kirill Wallet', 1500.00, 'USD');

INSERT INTO wallet_member (user_id, wallet_id, role)
VALUES (1, 1, 'OWNER'),
       (2, 2, 'OWNER'),
       (3, 3, 'OWNER');
...
VALUES
    ...
    (3, 'INCOME', 'BONUS', 'BANK_TRANSFER', 500.00, 'USD', 'Year-end Bonus', '2023-01-02 11:00:00',
     '2023-01-02 11:00:00'),
    (1, 'EXPENSE', 'TRAVEL', 'CARD', 200.00, 'USD', 'Flight Ticket', '2023-01-10 20:00:00', '2023-01-10 20:00:00'),
    (2, 'INCOME', 'FREELANCE', 'BANK_TRANSFER', 800.00, 'USD', 'Freelance Project', '2023-01-03 14:00:00',
     '2023-01-03 14:00:00'),
    ...
    (3, 'INCOME', 'GIFTS', 'BANK_TRANSFER', 200.00, 'USD', 'Birthday Gift', '2023-02-16 13:00:00',
     '2023-02-16 13:00:00'),
    (2, 'EXPENSE', 'SHOPPING', 'CARD', 300.00, 'USD', 'New Clothes', '2023-02-17 14:00:00', '2023-02-17 14:00:00'),
    (3, 'INCOME', 'RENT', 'BANK_TRANSFER', 1000.00, 'USD', 'Rental Income', '2023-02-18 12:00:00',
     '2023-02-18 12:00:00'),
    ...
    -- April
    (1, 'EXPENSE', 'TRAVEL', 'CARD', 120.00, 'USD', 'Hotel Booking', '2023-04-25 20:00:00', '2023-04-25 20:00:00'),
    (1, 'INCOME', 'FREELANCE', 'BANK_TRANSFER', 700.00, 'USD', 'Web Design', '2023-04-26 15:00:00',
     '2023-04-26 15:00:00'),
    (2, 'EXPENSE', 'HEALTH', 'CARD', 50.00, 'USD', 'Medicine', '2023-04-27 10:00:00', '2023-04-27 10:00:00'),
    (3, 'EXPENSE', 'TRANSPORT', 'CARD', 30.00, 'USD', 'Taxi', '2023-04-28 12:00:00', '2023-04-28 12:00:00'),
    ...
    -- June
    (1, 'EXPENSE', 'TRAVEL', 'CARD', 300.00, 'USD', 'Airline Ticket', '2023-06-10 20:00:00', '2023-06-10 20:00:00'),
    (3, 'INCOME', 'FREELANCE', 'BANK_TRANSFER', 900.00, 'USD', 'Freelance Project', '2023-06-15 14:00:00',
     '2023-06-15 14:00:00'),
    ...
    -- August
    (1, 'EXPENSE', 'SHOPPING', 'CARD', 400.00, 'USD', 'New Furniture', '2023-08-01 14:00:00', '2023-08-01 14:00:00'),
    (2, 'INCOME', 'RENT', 'BANK_TRANSFER', 1200.00, 'USD', 'Rental Income', '2023-08-05 12:00:00',
     '2023-08-05 12:00:00'),
    ...
    -- October
    (3, 'EXPENSE', 'TRAVEL', 'CARD', 150.00, 'USD', 'Hotel Booking', '2023-10-20 20:00:00', '2023-10-20 20:00:00'),
    (3, 'INCOME', 'FREELANCE', 'BANK_TRANSFER', 1000.00, 'USD', 'Freelance Project', '2023-10-25 14:00:00',
     '2023-10-25 14:00:00'),
    ...
    -- December
    (1, 'EXPENSE', 'SHOPPING', 'CARD', 500.00, 'USD', 'Christmas Gifts', '2023-12-01 14:00:00', '2023-12-01 14:00:00'),
    (2, 'INCOME', 'RENT', 'BANK_TRANSFER', 1300.00, 'USD', 'Rental Income', '2023-12-05 12:00:00',
     '2023-12-05 12:00:00'),
